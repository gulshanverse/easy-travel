...
const c = (x: MultiModalCapabilityContract): MultiModalCapabilityContract =>
  Object.freeze({
    ...x,
...
export const MULTIMODAL_CONTRACTS: Readonly<
  Record<MultiModalCapabilityId, MultiModalCapabilityContract>
> = Object.freeze({
  // ---------------- Flight ----------------
  search_flights: c({
    id: "search_flights",
    ...
    inputs: ["fromCode", "toCode", "date", "limit"],
    required: ["fromCode", "toCode"],
    output: "NormalizedFlight[]",
    cacheable: true,
    volatility: "slow",
  }),
  search_airports: c({
  ...
  flight_status: c({
    ...
    inputs: ["flightNumber", "date"],
    required: ["flightNumber"],
    output: "NormalizedFlightStatus",
    cacheable: false,
    volatility: "live",
  }),
  flight_schedule: c({
    ...
    inputs: ["flightNumber"],
    required: ["flightNumber"],
    output: "NormalizedFlightSchedule",
    cacheable: true,
    volatility: "slow",
  }),
  flight_metadata: c({
  ...
  fare_lookup: c({
    ...
    inputs: ["flightNumber", "cabin"],
    required: ["flightNumber"],
    output: "NormalizedTravelCost[]",
    cacheable: false,
    volatility: "live",
  }),
  flight_delay_information: c({
    id: "flight_delay_information",
    mode: "flight",
  ...
  search_hotels: c({
    ...
    inputs: ["city", "lat", "lon", "limit"],
    required: [],
    output: "NormalizedHotel[]",
    cacheable: true,
    volatility: "slow",
  }),
  search_rooms: c({
    ...
    inputs: ["hotelId", "guests"],
    required: ["hotelId"],
    output: "NormalizedRoom[]",
    cacheable: true,
    volatility: "slow",
  }),
  hotel_availability: c({
    ...
    inputs: ["hotelId", "checkIn", "checkOut"],
    required: ["hotelId"],
    output: "NormalizedHotelAvailability",
    cacheable: false,
    volatility: "live",
  }),
  hotel_pricing: c({
  ...
  distance_matrix: c({
    ...
    output: "NormalizedDistanceMatrix",
    cacheable: true,
    volatility: "slow",
  }),
  route: c({
  ...
  travel_time: c({
    ...
    inputs: ["from", "to", "mode"],
    required: ["from", "to"],
    output: "NormalizedTravelDuration",
    cacheable: true,
    volatility: "slow",
  }),
  coordinates: c({
  ...
  weather: c({
    ...
    inputs: ["lat", "lon", "place"],
    required: [],
    output: "NormalizedWeather",
    cacheable: false,
    volatility: "live",
  }),
  forecast_hourly: c({
    ...
    inputs: ["lat", "lon", "place", "hours"],
    required: [],
    output: "NormalizedForecast",
    cacheable: false,
    volatility: "live",
  }),
  forecast_daily: c({
  ...
  rain_probability: c({
    ...
    inputs: ["lat", "lon", "place"],
    required: [],
    output: "NormalizedWeatherMeasure",
    cacheable: false,
    volatility: "live",
  }),
  storm_alerts: c({
  ...
  local_transport: c({
    ...
    inputs: ["from", "to", "modes", "limit"],
    required: ["from", "to"],
    output: "NormalizedTransit[]",
    cacheable: true,
    volatility: "slow",
  }),
  transit_modes: c({
  ...
  currency_convert: c({
    ...
    output: "NormalizedCurrencyConversion",
    cacheable: false,
    volatility: "live",
  }),
  travel_budget_currency: c({
    id: "travel_budget_currency",
    mode: "currency",
    ...
    output: "NormalizedTravelBudgetCurrency",
    cacheable: false,
    volatility: "live",
  }),
...
export const MULTIMODAL_CONTRACT_LIST: readonly MultiModalCapabilityContract[] = Object.freeze(
  MULTIMODAL_CAPABILITY_IDS.map((id) => MULTIMODAL_CONTRACTS[id]),
);
