...
export const MULTIMODAL_TRAVEL_ENGINE_CONTRACT = Object.freeze({
  ...
  ownership: {
    owns: [
      ...
      "currency-runtime",
      "timezone-runtime",
      "travel-connector-registry",
      "travel-connector-factory",
      "travel-connector-resolver",
      "travel-connector-health",
      "travel-connector-metrics",
      "travel-capability-contracts",
      "travel-response-normalization",
      "mock-travel-providers",
      "travel-presentation-models",
    ],
    doesNotOwn: [
      "transport",
      "credentials",
  ...
  publicApis: [
    ...
    "CurrencyRuntime",
    "TimezoneRuntime",
    "TravelConnectorRegistry",
    "TravelConnectorFactory",
    "TravelConnectorResolver",
    "TravelConnectorHealth",
    "MultiModalMetrics",
    "MultiModalEventBus",
