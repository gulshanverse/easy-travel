...
export class WorkflowBuilder {
  ...
  constructor(
    private readonly opts: { id?: string; name: string; version: string; description?: string },
  ) {}
  step(s: Partial<WorkflowStep> & { id: string; name: string }): this {
    this.steps.push(makeWorkflowStep(s));
    return this;
  }
  trigger(t: WorkflowTrigger): this {
    this.triggers.push(t);
    return this;
  }
  withPolicy(p: Partial<WorkflowPolicy>): this {
    this.policy = { ...this.policy, ...p };
    return this;
  }
  withMetadata(m: Record<string, string>): this {
